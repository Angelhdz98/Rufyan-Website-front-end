...
import { Painting, PaintingDomainDetails, PaintingPricing, PaintingStock } from "../../types/typesIndex";
...
/**This will be "re-done" to enhance  the product polimorfism 
 * 
*/
function EditingPainting({ paintingId, ...rest }: EditingPaintingProps) {
  ...
  if (isLoading) {
    ...
    const toggleValueHandler = (field: keyof Painting) => {
      ...
      console.log("original availability: ", data, " Favorita: ", data.isFavorite);
    ...
    const updatePaintingHandler = (event: React.FormEvent<HTMLFormElement>) => {
      ...
      /*
      form.append('altura_cm',data.productDomainDetails.altura_cm.toString());
    ...
    */
    ...
    const renderedImages = data.images.map((singleImage) => {
    ...
    const paintingStock: PaintingStock = data.productStock as PaintingStock;

    const stringOriginalAvailable = paintingStock ? "true" : "false";
    const stringFavorite = data.isFavorite ? "true" : "false";

    const paintingDetails: PaintingDomainDetails = data.productDomainDetails as PaintingDomainDetails;
    const PaintingPricing: PaintingPricing = data.productPricing as PaintingPricing;
    ...
    */}
          ...
          <FormInput type={"text"} name={"category"}
            value={data.productTypeEnum.toString()}
            onChange={handleChange}>
            Estilo
          </FormInput>
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-col w-1/2"><FormInput type={"number"}
              name={"copies_made"}
              value={paintingStock.copiesMade.toString()}
              onChange={handleChange}>
              Copias realizadas
            </FormInput>
            </div>
          ...
          <div className="flex flex-row">
            <div className="w-4/5">
              <FormInput type={"number"} name={"price_copy"}
                value={PaintingPricing.pricePerCopy.toString()}
                onChange={handleChange}>
                Precio por copia
              </FormInput>
            </div>
            ...
            <div className="flex flex-col items-center w-full ">
              ...
              <div className="flex flex-row w-4/5 items-center">
                ...
                <CheckFormInput type={"checkbox"} name={"original_availability"}
                  checked={paintingStock.isOriginalAvailable}
              ...
              <div className="flex flex-row w-4/5 items-center">
                <CheckFormInput type={"checkbox"} name={"favorite"}
                  ...
                  onChange={() => toggleValueHandler("isFavorite")}
                  labelClassname="w-full"
                >
                  Favorita(o)
                </CheckFormInput>

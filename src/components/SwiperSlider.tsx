...
return isPainting(props.product)&& props.product.available_copies > 0 ?
   <di v className="Available-copies text-xs bg-white/70 absolute z-10 left-3 rounded px-1  bottom-2">Copies: {props.product.available_copies}/{props.product.copies_made}</div> :

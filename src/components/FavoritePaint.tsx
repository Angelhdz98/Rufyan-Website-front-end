...
<SwiperSlider onClick={()=> navigate(`store/paintings/${paint.id}`)} key={paint.id} images={paint.images} className="relative" product={paint} />
<ProductLabel onClick={onClick}  isVisible={isVisible} clicked={clicked} product={paint}    />
</div>)
